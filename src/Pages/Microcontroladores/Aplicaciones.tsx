...
const Aplicaciones = () => {
  return (
    <Background text="Aplicaciones de Microcontroladores">
      ...
      <Parrafo>
        Los microcontroladores son el corazón de miles de dispositivos
        inteligentes que usamos todos los días. Gracias a su capacidad de
        procesar datos, controlar señales y comunicarse, pueden automatizar
        tareas, monitorear procesos, tomar decisiones y responder a estímulos
        del entorno en tiempo real.
      </Parrafo>

      <Parrafo>
        Desde una simple luz que se enciende automáticamente, hasta un dron que
        se estabiliza en vuelo, hay un microcontrolador detrás.
      </Parrafo>
      ...
      <Parrafo>
        Microcontroladores como Arduino, PIC o STM32 permiten prototipar ideas
        reales con bajo costo.
      </Parrafo>
      ...
      <Parrafo>
        Los microcontroladores están en el centro de la revolución digital
        embebida. Son esenciales en la automatización, inteligencia artificial
        distribuida, IoT y robótica. Comprender sus aplicaciones permite crear
        soluciones reales e innovadoras para mejorar el mundo físico.
      </Parrafo>
    </Background>
  );
};
