      ...
      <div className="max-w-4xl p-8 rounded-2xl shadow-xl backdrop-blur-lg">
        ...
        <p className="text-lg text-gray-700 mb-4 text-justify">
          ...
          <ul className="list-decimal list-inside text-gray-700 space-y-2">
            ...
            <li>
              La manera en la que se accede a la memoria y los registros (modos
              de direccionamiento).
            </li>
          </ul>
          <p className="mt-2 mb-2">
        ...
        <h3 className="text-md font-bold text-gray-600 mb-5">
          La organización de computadoras se refiere a la implementación física
          de la arquitectura. Esto incluye todos los detalles de hardware:
        </h3>
        ...
        <ul className="list-decimal list-inside text-gray-700 space-y-2">
          ...
          <p className="text-md">
            Describe los componentes físicos principales que conforman un
            sistema computacional. Son las "piezas" del hardware que interactúan
