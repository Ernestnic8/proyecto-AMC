    ...
    <div className="min-h-screen bg-white/60 flex items-center justify-center p-6">
      <div className="max-w-4xl p-8 rounded-2xl shadow-xl backdrop-blur-lg">
        ...
        <p className="text-lg text-gray-700 mb-4 text-justify">
          Un microprocesador es un circuito integrado que actúa como el cerebro
          de un sistema computacional. Su función principal es ejecutar
          instrucciones almacenadas en memoria y coordinar el funcionamiento de
          todos los demás componentes del sistema, como la memoria, los
          dispositivos de entrada/salida y los buses de datos. Desde su
          aparición en la década de 1970 con el Intel 4004, los
          microprocesadores han evolucionado significativamente, permitiendo la
          construcción de computadoras personales, servidores, teléfonos
          inteligentes y otros dispositivos electrónicos de alto rendimiento.
        </p>
        ...
        <ul className="list-decimal list-inside text-gray-700 space-y-2">
          ...
          <li>
            <strong>Decodificación (Decode):</strong> interpretan la
            instrucción.
          </li>
          <li>
          ...
          <li>
            <strong>Escritura (Write-back):</strong> almacenan el resultado, si
            es necesario.
          </li>
        </ul>
        ...
        <ul className="list-disc list-inside text-gray-700 space-y-2">
          <li>
            Ejecuta programas, desde sistemas operativos hasta videojuegos.
          </li>
          <li>Controla el flujo de datos dentro de un sistema.</li>
          <li>
            Es fundamental en tareas de procesamiento lógico y aritmético.
          </li>
          <li>
            Se encuentra presente no solo en computadoras, sino en casi
            cualquier dispositivo moderno (impresoras, routers, cámaras, etc.).
          </li>
        </ul>
        <h2 className="text-2xl font-semibold text-blue-800 mt-6 mb-4 text-center">
        ...
        <ul className="list-disc list-inside text-gray-700 space-y-2">
          <li>
            <strong>Computadoras personales:</strong> para ejecutar
            aplicaciones, juegos y software de oficina.
          </li>
          <li>
